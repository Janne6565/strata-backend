...
import com.janne6565.stratabackend.catalog.CredentialSource;
...
public class CredentialReader {
    ...
    private Map<String, String> resolveValues(Datasource datasource) {
        CredentialResolution resolution = datasource.getCredentialResolution();
        if (resolution == null) {
            throw new BadRequestException("Datasource has no resolved credentials");
        }
