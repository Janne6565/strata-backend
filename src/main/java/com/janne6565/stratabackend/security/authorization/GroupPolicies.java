 ...
 * Collection-level update operations (reorder) carry no {@code referenceId} and are allowed, with
 * the service scoping the change to the caller's groups. Keep pure and unit-testable.
 */
@Component
