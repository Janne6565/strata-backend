 ...
 * type so the service layer and {@link ExceptionController} stay engine-agnostic. The message is a
 * safe summary — never secret material or full payloads (AUTH.md).
 */
