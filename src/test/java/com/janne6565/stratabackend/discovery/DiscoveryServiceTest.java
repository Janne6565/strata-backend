...
import com.janne6565.stratabackend.config.properties.DiscoveryProperties;
import com.janne6565.stratabackend.config.properties.DiscoveryProperties.Credentials;
import com.janne6565.stratabackend.config.properties.DiscoveryProperties.Detector;
import com.janne6565.stratabackend.config.properties.DiscoveryProperties.Match;
import com.janne6565.stratabackend.kubernetes.CredentialResolver;
import com.janne6565.stratabackend.kubernetes.KubernetesScanner;
import com.janne6565.stratabackend.kubernetes.WorkloadDescriptor;
...
class DiscoveryServiceTest {
    ...
    private Datasource stale(String discoveryKey, DatasourceStatus status) {
    ...
    void marksRowsNotSeenThisScanAsMissing() {
        Datasource gone = stale("default/Deployment/old", DatasourceStatus.PRESENT);
    ...
    void refreshesExistingWorkloadBackToPresent() {
        Datasource existing = stale("default/Deployment/orders", DatasourceStatus.MISSING);
        when(scanner.scan()).thenReturn(List.of(pgWorkload("orders")));
        when(datasourceRepository.findByDiscoveryKey("default/Deployment/orders"))
